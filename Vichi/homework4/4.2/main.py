...
for i in range(len(KF)):
    print(KF[i].__name__, "J(h) = ", KF[i](f, a, b, m))
    print(" Величина невязки = ", abs(KF[i](f, a, b, m) - If(a, b)))
    print("Теоретическая ошибка = ", error(C[i], maxim(deriv[d[i] + 1],a,b,0.001), a, b, m, d[i]))
